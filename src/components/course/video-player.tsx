    ...
    return (
      ...
      >
        ...
        <div className="absolute bottom-8 right-8 z-10">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" className="text-brand-purple drop-shadow-lg transition-transform transform group-hover:scale-110">
            <defs>
              <mask id="SVGOVEmxbON">
